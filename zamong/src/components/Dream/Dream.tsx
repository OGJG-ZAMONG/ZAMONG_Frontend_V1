        ...
        <>
            <S.DreamContainer>
                <S.DreamImage img={defaultImage}>
                    <S.DreamUserImage alt='user image' src={defaultImage} onMouseEnter={() => {setIsUserImageHover(true)}} onMouseLeave={() => {setIsUserImageHover(false)}}/>
                    {isUserImageHover && <S.UserName>USER04</S.UserName>}
                </S.DreamImage>
                <S.DreamInfoContainer>
                    <S.DreamTitle>대법관은 대법원장의 제청으로 국회의 동의를 얻어 대통령이 임명한다. 대통령은 조약을...</S.DreamTitle>
